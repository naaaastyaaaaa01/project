const facts = [
    ...
    "Денис пересматривал "Декстера" целиком 5 раз. И каждый раз надеюсь, что финал в этот раз будет другим",
    "Денис "обожет играть в шахматы"",
    "Никита дюбил играть в баскетбол в детстве",
    "Никита 3 года ходит в тренажёрный зал и еще до этого 1-2 года занимался дома",
    "Во время съемки ни один ноутбук не пострадал"
];
