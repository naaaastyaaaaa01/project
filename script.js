const facts = [
    ...
    "Денис пересматривал Декстера целиком 5 раз. И каждый раз надеется, что финал в этот раз будет другим",
    "Денис обожает играть в шахматы",
    "Никита любил играть в баскетбол в детстве",
    "Никита 3 года ходит в тренажёрный зал и ещё до этого 1-2 года занимался дома",
    "Во время съёмки ни один ноутбук не пострадал"
];
